...
import '../providers/all_in_one_list_provider.dart';
...
class AllInOneListPage extends ConsumerStatefulWidget {
  const AllInOneListPage({super.key});

  @override
  ConsumerState<AllInOneListPage> createState() => _AllInOneListPageState();
}

class _AllInOneListPageState extends ConsumerState<AllInOneListPage> {
  String searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    final productsAsync = ref.watch(allInOneFirebaseProvider);
