...
class AddAllInOneScreen extends StatefulWidget {
  const AddAllInOneScreen({super.key});

  @override
  State<AddAllInOneScreen> createState() => _AddAllInOneScreenState();
}

class _AddAllInOneScreenState extends State<AddAllInOneScreen> {
  final CollectionReference allInOneRef =
      FirebaseFirestore.instance.collection("all_in_one");
  ...
  // ---------- SAVE ALL IN ONE ----------
  Future<void> saveAllInOne() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Admin Panel – All In One"),
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            _buildTextField(nameController, "All In One Name"),
